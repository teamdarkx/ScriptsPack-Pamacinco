...
function warnSomeone(id, reason) {
    ...
    if (n <= 1) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("success", n);
    }
    else if (n == 2) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("warning", n);
    }
    else if (n >= 3) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("danger", n);
    }
...
function addWarns(warn_data) {
    ...
    if (warn_data == undefined) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("success", 0);
        return;
    }

    if (warn_data.length <= 1) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("success", warn_data.length);
    }
    else if (warn_data.length == 2) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("warning", warn_data.length);
    }
    else if (warn_data.length >= 3) {
        document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("danger", warn_data.length);
    }
...
function Client() {
    ...
    document.getElementById("warn_n").innerHTML = "Total avisos: " + Badge("info", "Loading...");
    ...
    return_button.innerText = "Volver";
    ...
    noclip_button.innerText = "No clip";
    ...
    visibility_button.innerText = "Invisible";
    ...
    freeze_button.innerText = "Freezear";
    ...
    unjail_button.innerText = "Un Jail";
...
function ServerF() {
    ...
    bring_all.innerText = "Traer a todos";
    ...
    slay_all.innerText = "Matar a todos";
    ...
    revive_all.innerText = "Revivir a todos";
    ...
    freeze_all.innerText = "Freeze a todos";
